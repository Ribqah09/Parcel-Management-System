...
public class AdminDeliveryHistory extends javax.swing.JFrame {

    public AdminDeliveryHistory() {
        initComponents();
        setLocation(30,0);
        try {
            Connection c=new Connection();
            ResultSet rs = c.s.executeQuery("SELECT * FROM parcels WHERE status = 'Delivered' ORDER BY priority");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminDeliveryHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminDeliveryHistory().setVisible(true);
            }
        });
    }
