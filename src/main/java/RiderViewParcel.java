...
public class RiderViewParcel extends javax.swing.JFrame {

    public RiderViewParcel() {
        initComponents();
        setLocation(150,0);
        try {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("VIEW ALL PARCEL");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        RiderDashboard u=new RiderDashboard();
        u.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RiderViewParcel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RiderViewParcel().setVisible(true);
            }
        });
    }
