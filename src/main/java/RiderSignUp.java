...
public class RiderSignUp extends javax.swing.JFrame {
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        try {
            ...
            String addQuery=("insert into riderlogin values('"+id+"','"+username+"','"+contactno+"','"+email+"','"+dob+"','"+password+"')");
            conn.s.executeUpdate(addQuery);
            JOptionPane.showMessageDialog(null, "Details Added Successfully!");
            setVisible(false);
            RiderLogin h=new RiderLogin();
            h.setVisible(true);
        }
        catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RiderSignUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RiderSignUp().setVisible(true);
            }
        });
    }
