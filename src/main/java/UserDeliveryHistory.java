...
public class UserDeliveryHistory extends javax.swing.JFrame {
    ...
    public UserDeliveryHistory() {
        ...
        try {
            ...
            ResultSet rs = c.s.executeQuery("SELECT id, senderName, senderAddress, receiverName, receiverAddress, DeliveryCharges, city, status " +
                                    "FROM parcels " +
                                    "WHERE status = 'Delivered' AND user_id = " + userId + " " +
                                    "ORDER BY priority");
    ...
    private void initComponents() {
        ...
        jLabel12.setText("YOUR PAST PARCELS");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Parcel ID", "Sender's Name", "Sender's Address", "Receiver's Name", "Receiver's Address", "Delivery Charges", "City"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserDeliveryHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserDeliveryHistory().setVisible(true);
            }
        });
    }
