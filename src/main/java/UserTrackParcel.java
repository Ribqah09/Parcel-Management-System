...
public class UserTrackParcel extends javax.swing.JFrame {
    public UserTrackParcel() {
        initComponents();
        setLocation(250,0);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(31, 123, -1, -1));
        ...
        jPanel1.add(txtParcelID, new org.netbeans.lib.awtextra.AbsoluteConstraints(31, 151, 246, -1));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 620, -1));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 620, -1));
        ...
        jPanel1.add(track, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 80, -1));

        lblStatus.setFont(new java.awt.Font("Segoe UI Semibold", 0, 18)); // NOI18N
        jPanel1.add(lblStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 450, 490, 50));
        ...
        jPanel1.add(btnback, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 540, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smartparcelmanagement/v.jpg"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, -4, 620, 630));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserTrackParcel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserTrackParcel().setVisible(true);
            }
        });
    }
